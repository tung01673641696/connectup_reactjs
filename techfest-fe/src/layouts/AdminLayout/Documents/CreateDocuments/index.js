    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (!isValid("enterprise", x)) {
                ...
                if (res.status === 400) {
                    notifyError("Tạo tài liệu không thành công")
                } else {
                    notifySuccess("Tạo tài liệu thành công")
                    setTimeout(() => {
            ...
            <div className={cx('inner')}>
                ...
                <div className={cx('main-content')}>
                    <div className={cx('content')}>
                        ...
                        <ButtonComponent primary small onClick={handleSave}>Tạo tài liệu</ButtonComponent>
                    </div>
                </div>
            </div>
        </div>)
